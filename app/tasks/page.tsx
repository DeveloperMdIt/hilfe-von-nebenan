        ...
        <div className="min-h-screen bg-gray-50 dark:bg-black font-[family-name:var(--font-geist-sans)]">
            ...
            <div className="bg-white dark:bg-zinc-900 border-b border-gray-200 dark:border-zinc-800 sticky top-0 z-10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-4">
                    <Link href="/" className="text-xl font-bold">Hilfe von Nebenan</Link>
                    <div className="w-full max-w-md">
                        {/* Reusing simplified search bar logic here if needed, or keeping it clean */}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    {allTasks.map((task) => (
                        <div
                            key={task.id}
                            className="group bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all hover:-translate-y-1"
                        >
                            ...
                            <div className="flex items-center gap-1.5 mb-3">
                                <span className="text-xs font-medium text-gray-500">von {task.requesterName || 'Anonym'}</span>
                                {task.isHelperBadge && (
                            ...
                            <div className="flex items-center gap-4 text-xs text-gray-500 mb-6 border-t border-gray-100 dark:border-zinc-800 pt-4">
                                {/* Distance placeholder hidden until we have geo-location */}
                                {/* <span className="flex items-center gap-1"><MapPin size={14} /> 1.2km</span> */}
                    ...
                    {allTasks.length === 0 && (
                        <div className="col-span-full flex flex-col items-center justify-center py-20 text-gray-500 bg-white dark:bg-zinc-900 rounded-2xl border border-dashed border-gray-300">
                            ...
                            <Link href="/tasks" className="text-amber-600 hover:underline mt-2">Alles anzeigen</Link>
                        </div>
                    )}
                </div>
            </div>
